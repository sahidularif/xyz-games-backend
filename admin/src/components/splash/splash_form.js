      ...
      <div className="main-splash">
        ...
        <div className="age-buttons">
            ...
            <div className="splash-text">
              Welcome to BETBAY! BETBAY is a MERN-Stack web-application that is modeled after real-life live sports betting applications and is specific to NBA Basketball games.
